export default {
  ...
  'olympisch-stadion': {
    huubSpotName: 'Olympisch stadion',
    vehicles: {
      'middenklasser': [
        {
          vehicleId: 'AFD-4-A',
          mainBatteryPercentage: 83,
